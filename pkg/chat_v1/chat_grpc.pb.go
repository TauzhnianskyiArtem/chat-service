...
type ChatV1Client interface {
	Create(ctx context.Context, in *ChatCreateRequest, opts ...grpc.CallOption) (*ChatCreateResponse, error)
	SendMessage(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	Delete(ctx context.Context, in *ChatDeleteRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *chatV1Client) Create(ctx context.Context, in *ChatCreateRequest, opts ...grpc.CallOption) (*ChatCreateResponse, error) {
	out := new(ChatCreateResponse)
...
func (c *chatV1Client) Delete(ctx context.Context, in *ChatDeleteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ChatV1Server interface {
	Create(context.Context, *ChatCreateRequest) (*ChatCreateResponse, error)
	SendMessage(context.Context, *SendMessageRequest) (*empty.Empty, error)
	Delete(context.Context, *ChatDeleteRequest) (*empty.Empty, error)
...
func (UnimplementedChatV1Server) Create(context.Context, *ChatCreateRequest) (*ChatCreateResponse, error) {
...
func (UnimplementedChatV1Server) Delete(context.Context, *ChatDeleteRequest) (*empty.Empty, error) {
...
func _ChatV1_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatV1Server).Create(ctx, req.(*ChatCreateRequest))
	}
...
func _ChatV1_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatV1Server).Delete(ctx, req.(*ChatDeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
